...
def valid_number_plate(num):
    ...
    if 11>len(num)>7 and state_code == "DL" and num[2].isdigit():
        print("private vehicles")
        print(len(num), "lenght ",num)
        if (len(num)==10) and (num[4].isalpha() and num[5].isalpha()):
            ...
            return False
    elif 12>len(num)>7 and num[0].isalpha() and num[1].isalpha() and state_code in valid_state_code and num[2].isdigit() and num[3].isdigit():
        print("private vehicles")
        print(len(num), "lenght ",num)
...
def choose(st,ch):
    if ('Q' in st or 'O' in st) and 'D' in st:
        return 'D'
    if 'H' in st and ('M' in st or 'N' in st):
        return 'M'
